...
function descarga(){
    ...
    if (soldadura == "INTERNA") {
        for(i=1;i<=3;i++){
            urlf = direccion_pagina + "/backend/api/internas/ar_tTuberiaInterna_"+i+".php?T_ID_Rtubo=" + ID_tubo;
        ...
        for(i=1;i<=3;i++){
            urlf = direccion_pagina + "/backend/api/externas/ar_tTuberiaExterna_"+i+".php?T_ID_Rtubo=" + ID_tubo;
