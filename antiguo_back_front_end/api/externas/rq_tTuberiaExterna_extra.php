...
function cargar_ID_Rtubo()
{
    ...
    global $conn;
    $sql="UPDATE tuberia_soldadura_externa_extra SET Tex_ID_Rtubo='".$T_id_Rtubo."' WHERE Tex_ID_tubo=".$id_tubo;
    
    if ($conn->query($sql) === TRUE) {
        echo "Se registro/actualizo id Rtubo en soldadura extra ID_tubo= " . $id_tubo;
    } else {
        echo "Error: " . $sql . "<br>" . $conn->error;
    }
}
