...
{
    $sql = "SELECT * FROM tuberia_soldadura_interna_1 WHERE Tin_No_tubo=\"" . $T_No_tubo . "\"";
    global $conn;
    $query = $conn->query($sql);
    $data = array();
    while ($r = $query->fetch_assoc()) {
...
function cargar_ID_Rtubo()
{
    ...
    global $conn;
    $sql="UPDATE tuberia_soldadura_interna_1 SET Tin_ID_Rtubo='".$T_id_Rtubo."' WHERE Tin_ID_tubo=\"" . $id_tubo . "\"";
