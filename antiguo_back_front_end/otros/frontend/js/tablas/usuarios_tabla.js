function Cargar_plantilla_usuarios(){
    ...
    urlf ="https://10.10.20.15/api/rq_tUsuarios.php?usuario=";
...
function Actualizar_datos_usuario(){
    if(document.getElementById("usuarioA").value!=="")
    {
        ...
        let urlf = "https://10.10.20.15/api/rq_tUsuarios.php?usuario="+usuario_A;
        console.log(urlf);
        fetch(urlf).then(response =>response.json()) 
...
function borrar_operador(){
    ...
    let urlf = "https://10.10.20.15/api/rq_tUsuarios.php";
