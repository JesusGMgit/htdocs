function Cargar_plantilla_soldadura_interna(){
    ...
    for(i=1;i<=3;i++){
        ...
        url_tabla ="https://10.10.20.15/api/internas/rq_tTuberiaInterna_"+i+".php";
...
function Actualizar_datos_tuberia_in(){
    if((document.getElementById("id_tubo").value!=="INGRESE ID DE TUBO") && (document.getElementById("maquina").value))
    {
        ...
        if(a_maquina=="INTERNA1"){
            urlf = "https://10.10.20.15/api/internas/rq_tTuberiaInterna_1.php?tubo="+id_tubo;
        }else if(a_maquina=="INTERNA2"){
            urlf = "https://10.10.20.15/api/internas/rq_tTuberiaInterna_2.php?tubo="+id_tubo;
        }else {
            urlf = "https://10.10.20.15/api/internas/rq_tTuberiaInterna_3.php?tubo="+id_tubo;
        }
