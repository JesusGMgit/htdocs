function Cargar_plantilla_soldadura_externa(){
    ...
    for(i=1;i<=3;i++){
        ...
        url_tabla ="https://10.10.20.15/api/externas/rq_tTuberiaExterna_"+i+".php";
...
function Actualizar_datos_tuberia_ex(){
    if(document.getElementById("id_tubo").value!==""&& (document.getElementById("maquina").value))
    {
        ...
        if(a_maquina=="EXTERNA1"){
            urlf = "https://10.10.20.15/api/externas/rq_tTuberiaExterna_1.php?tubo="+id_tubo;
        }else if(a_maquina=="EXTERNA2"){
            urlf = "https://10.10.20.15/api/externas/rq_tTuberiaExterna_2.php?tubo="+id_tubo;
        }else {
            urlf = "https://10.10.20.15/api/externas/rq_tTuberiaExterna_3.php?tubo="+id_tubo;
        }
