function Cargar_plantilla_proyectos(){
    ...
    Actualizar_proyecto();
    Eliminar_proyecto();
    urlf ="https://10.10.20.15/api/rq_tProyectos.php?id=";
...
function Actualizar_datos_proyecto(){
    if(document.getElementById("id_proyecto").value!=="")
    {
        ...
        let urlf = "https://10.10.20.15/api/rq_tProyectos.php?id="+id_proyecto;
        fetch(urlf).then(response =>response.json()) 
...
function borrar_proyecto(){
    ...
    let urlf = "https://10.10.20.15/api/rq_tOperadores.php";
