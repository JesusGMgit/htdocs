<?php
//TODO revisar espacios en blanco y comentarios que sobran todos iguales
...
switch ($_SERVER['REQUEST_METHOD']) {
    ...
    case 'PUT':
        ...
        if($_PUT != NULL) {
            ...
            if(isset($array_columnas[3]))
            {
                soldadura_interna::actualizar_todos_valores_tubo_interna($Maquina,$array_columnas,$array_datos);
            }
            elseif(soldadura_interna::actualizar_unvalor_tubo_interna($Maquina,$array_columnas[0],$array_datos[0],
                                                                               $array_columnas[1],$array_datos[1])){
                http_response_code(200);
            }
            else {
                http_response_code(400);
